...
Exp9 : Exp12 '++' { AbsKotlin.EPinc $1 }
     ...
     | Exp10 { $1 }
Exp10 :: { Exp }
Exp10 : '[' Iterable ']' { AbsKotlin.Eiter $2 }
      | 'Array' '(' Exp ',' Exp ')' { AbsKotlin.Earray $3 $5 }
      | 'Tupla' '(' ListExp ')' { AbsKotlin.Etupla $3 }
...
Stm : Dec { AbsKotlin.Sdec $1 }
    ...
    | 'for' '(' Ident 'in' Exp ')' '{' ListStm '}' { AbsKotlin.Sfor $3 $5 (reverse $8) }
...
Iterable :: { Iterable }
Iterable : Exp '..' Exp { AbsKotlin.Itrange $1 $3 }
